 ...
 * 
 */
@WebServiceClient(name = "HelloServiceImplService", targetNamespace = "http://server.soap.ginopc.it/", wsdlLocation = "http://localhost:8080/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.ginopc.it/", "HelloServiceImplService");
    ...
    public HelloService getHelloServiceImplPort() {
        return super.getPort(new QName("http://server.soap.ginopc.it/", "HelloServiceImplPort"), HelloService.class);
    }
    ...
    public HelloService getHelloServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.ginopc.it/", "HelloServiceImplPort"), HelloService.class, features);
    }
